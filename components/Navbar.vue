...
<template>
        <nav class="max-w-screen-xl mx-auto flex justify-center items-center pt-6">
        ...
        <li class="" v-for="route in routesData" :key="route.path">
            <NuxtLink class="p-2 text-black opacity-75 hover:underline font-medium"  :to="route.path">{{ route.label }}</NuxtLink>
        </li>
        </ul>
    </nav>
</template>